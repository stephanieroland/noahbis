...
jQuery(document).ready(function($) {
	...
	$(document).on("click", ".incr-btn", function(e) {
        ...
        var totalCostText = $('.total-cost i');
        ...
        var quantitymeal = $('.meal-quantity i');
         ...
         var quantitymoitie = $('.moitie-quantity i');
         var quantitypurification = $('.purification-quantity i');
         var quantitybars = $('.bars-quantity i');
        ...
        localStorage.setItem("quantity", newVal);
       ...
       quantitywater.text(parseInt(newVal)*18);
        quantitymeal.text(parseInt(newVal)*3);
        quantityblanket.text(parseInt(newVal));
        quantitymoitie.text(Math.ceil(parseInt(newVal)*0.5));
          quantitypurification.text(parseInt(newVal)*5);
             quantitybars.text(parseInt(newVal)*2);
                $(".pay").data("price", totalCost * 100);
